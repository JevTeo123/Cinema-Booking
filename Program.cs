...
namespace PRG2_P11_Team3
{
    class Program
    {
        ...
        static void listcinemas(List<Cinema> c)
        {
            ...
            for (int i = 1; i < cinemadata.Count(); i++)
            {
                string[] cinema = cinemadata[i].Split(',');  //Please change it so that it will only display cinema name and hall number for addmoviescreeningsession
                Cinema newC = new Cinema(cinema[0], Convert.ToInt32(cinema[1]), Convert.ToInt32(cinema[2]));
                c.Add(newC);
                Console.WriteLine("{0, -20}{1, -20}", cinema[0], cinema[1]);
            }
        }
                        ...
                        if (s_type == "2D" || s_type == "3D")
                        {
                            while (true)
                            {
                                try // Ensures that the entered screening is a valid datetime
                                {
                                    ...
                                    {
                                        foreach (Screening d in sL)
                                        {
                                            if (dt >= d.Movie.openingDate)
                                            {
                                                Console.WriteLine("{0, -20}{1, -20}", "Cinema", "Hall Number");
                                        ...
                                        while (true)
                                        {
                                            try
                                            {
                                                Console.WriteLine("Enter a cinema hall number in the format stated (cinema name;hall number):");
                                                ...
                                                if (details.Length == 2)
                                                {
                                                    ...
                                                    {
                                                        if (i.Cinema.name.ToLower() == details[0].ToLower() && i.Cinema.hallNo == Convert.ToInt32(details[1]))
                                                        {
                                                    ...
                                                    if (tocreate)
                                                    {
                                                        ...
                                                        Cinema chosenC = FindCinema(details[0], Convert.ToInt32(details[1]), cL);
                                                ...
                                                {
                                                    Console.WriteLine("Your input string was not in the correct format as stated");
                                                    continue;
                                                }
                                                break;
                                            }
